...
$('.formphp').on('submit', function() {
  var emailContato = "contato@jonaslobo.com.br"; // Escreva aqui o seu e-mail
  ...
  $.ajax({
    ...
    success: function(response) {
      ...
      if( $('[name="leaveblank"]').val().length != 0 ) {
        ...
        $('#form-erro').html("<span>Opa, não foi dessa vez!</span><p>Verifique novamente os campos abaixo. " + emailContato + " </p>")
        .hide()
